...
class Alipay {
  ...
  getOrderInfoStr (bizContent) {
    const { params, sign } = this.paramsComb('alipay.trade.app.pay', bizContent)
   ...
   * @return String
   */
  getWapPageURL (bizContent) {
    const { params, sign } = this.paramsComb('alipay.trade.wap.pay', bizContent)
